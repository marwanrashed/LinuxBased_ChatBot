...
ChatLogic::ChatLogic()
{
    //// STUDENT CODE
    ////
        std::cout << "This is the ChatLogic Constructor" << std::endl;
...
ChatLogic::~ChatLogic()
{
    ...
    // delete _chatBot;
    std::cout << "This is the ChatLogic Destructor" << std::endl;
    // // delete all nodes
...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
    ...
    ChatBot chabot_instance ("../images/chatbot.png");
    SetChatbotHandle(&chabot_instance);
    chabot_instance.SetChatLogicHandle(this);
    rootNode->MoveChatbotHere(std::move(chabot_instance));
    chabot_instance.SetRootNode(rootNode);
